...
```
In this example, a request for `/withastro/astro/tree/main/docs/public/business-startup.svg` would be split into the following named parameters:
...
```js
{
	...
	repo: 'astro',
	branch: 'main',
	file: 'docs/public/business-startup.svg'
}
```
