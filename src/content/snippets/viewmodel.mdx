---
title: 'States and effects management boilerplate for views and view models'
description: 'For use with KMM, Jetpack Compose and SwiftUI.'
logo: 'kmm.png'
---
