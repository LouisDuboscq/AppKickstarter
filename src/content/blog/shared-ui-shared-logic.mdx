---
draft: false
title: "Shared UI vs Shared Logic: Embracing Kotlin Multiplatform's Approach"
...
In this article, we will explore the advantages of Kotlin Multiplatform (KMP), its unique approach of optionally sharing code, and how it addresses the challenges of Shared UI while embracing Shared Logic.
