...
image: {
    ...
    alt: "Practical introduction to KMM"
}
...
The "Practical intro to KMM" is a short guide that covers the essential information you need to know to create a Kotlin Multiplatform mobile app. 
...
I'm Louis, a mobile developer who started using Kotlin Multiplatform mobile (KMM) in 2019. 
