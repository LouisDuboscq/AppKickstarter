...
And to use it in your shared UI in commonMain, as the commonMain package does not have access to iOSMain (the way KMM architecture works), 
...
If you enjoyed it and want to learn more about building android and iOS apps thanks to KMM and Compose multiplatform subscribe to our newsletter.