---
draft: false
title: "Basic Jetbrains Compose multiplatform setup to render ui on iOS with SwiftUI"
...
Doing this, you made a UI Kit controller and you have to use UIViewControllerRepresentable to expose it as a standard SwiftUI component.
