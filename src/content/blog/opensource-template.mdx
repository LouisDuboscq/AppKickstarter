---
draft: false
title: "Open source KMP (Kotlin multiplatform) template"
...
image: {
    ...
    alt: "Open source KMP template and Compose multiplatform template"
}
...
This frees up time for developers to focus on building the unique features of their app, rather than dealing with template code and setup.
