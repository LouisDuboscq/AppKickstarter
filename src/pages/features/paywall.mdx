...
AppKickstarter billing management is based on RevenueCat.
...
In RevenueCat, create your offerings and AppKickstarter will display in the paywall the current offering. 
We support and recommend to set in an offering one package for annual, monthly, weekly and a one time payment for a lifetime access.

AppKickstarter will compute the discount for the yearly plan and will highlight it. 
For example if you create an offering with a monthly for 7euro/month and yearly for 45euro/month, AppKickstarter will display this screen :
<p align="center"> 
 <img src="/images/paywall.jpeg" alt="Paywall in AppKickstarter" width="300" /> 
</p>
